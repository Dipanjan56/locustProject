...
# Terminal -> locust -f basics/basic_locust_01_report_statistics.py -u 5 -r 1 -t 10s --headless --csv=reportdata/myData
# here above it means it will download the data after completion of the run i.e. 10 sec

# now if we run this: locust -f basics/basic_locust_01_report_statistics.py -u 5 -r 1 --headless --csv=reportdata/myData -t2s --run-time 10s
