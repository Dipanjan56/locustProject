# if system is not able to find the credentials.py path, then we need to uncomment this below code
# import sys
...
# Terminal -> locust -f basics/basic_locust_01_multipleUser_externalModule.py -u 5 -r 1 --headless
