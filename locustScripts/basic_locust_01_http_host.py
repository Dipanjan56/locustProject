...
# Terminal -> locust -f locustScripts/basic_locust_01_http_host.py -u 5 -r 1 -t 10s --headless --logfile logFiles/mylog.log --loglevel DEBUG
...
# Terminal -> locust -f locustScripts/basic_locust_01_http_host.py -u 1 -r 1 --headless --only-summary
